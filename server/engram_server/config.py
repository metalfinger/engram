...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_file=".env", env_prefix="ENGRAM_", extra="ignore")
    ...
    explorer_url: str = "https://brain.metalfinger.xyz"  # explorer host (Cloudflare Access)
    ...
    dev_no_access: bool = False  # NEVER enable in production (tunnel origin = 127.0.0.1)
